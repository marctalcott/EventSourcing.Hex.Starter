...
{
    public class ActivateAd : IRequest
    {
        public EventUserInfo EventUserInfo { get; }
        public Guid Id { get; }

        public ActivateAd(EventUserInfo eventUserInfo, Guid id)
        {
    ...
    public class ActivateAdHandler : IRequestHandler<ActivateAd>
    {
        private IRepository _repo;

        public ActivateAdHandler(IRepository repo)
        {
            _repo = repo;
        }
